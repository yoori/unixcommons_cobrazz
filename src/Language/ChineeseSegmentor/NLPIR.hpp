...
namespace Language::Segmentor
{
  namespace Chineese
  {
    ...
    {
    public:
      explicit NlpirSegmentor(const char* path = "/usr/share/NLPIR")
    ...
    protected:
      static const char* put_spaces_(const char* phrase, size_t phrase_len)
        /*throw (eh::Exception)*/;

      virtual ~NlpirSegmentor() noexcept;
    };
    using NlpirSegmentor_var = ReferenceCounting::ConstPtr<NlpirSegmentor>;
  }
}

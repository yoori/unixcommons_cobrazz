...
namespace Language::Segmentor
{
  namespace Korean
  {
    ...
    {
    public:
      explicit MoranSegmentor(const char* config_file) /*throw (UniqueException)*/;
    ...
    protected:
      virtual ~MoranSegmentor() noexcept;

      bool is_valid_utf8_(const char* str, size_t str_len) const noexcept;
    };
    using MoranSegmentor_var = ReferenceCounting::ConstPtr<MoranSegmentor>;
  } //namespace Korean
}

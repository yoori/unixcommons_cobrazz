...
namespace Stream::File
{
  struct IO : private Generics::Uncopyable
  {
    ...
    virtual size_t read(void* buf, size_t size) /*throw (eh::Exception)*/ = 0;

    virtual void write(const void* buf, size_t size) /*throw (eh::Exception)*/ = 0;
  };
  ...
  public:
    ...
    virtual int_type underflow() /*throw (Underflow, eh::Exception)*/;

...
namespace Stream::MemoryStream
{
  ...
  public:
     ...
     */
    explicit MMapStream(const char* filename, size_t size = 0, off_t offset = 0)
...
namespace Stream
{
  using FileParser = MemoryStream::MMapStream<char>;
  using WFileParser = MemoryStream::MMapStream<wchar_t>;
}

...
namespace UServerUtils::Grpc::Core::Server
{
  ...
  public:
    explicit Server(const Config& config, Logger* logger);
    ...
    void register_handler()
    {
      ...
      {
        Stream::Error stream;
        stream << FNS << " : not correct format for full method name of method=" <<
          method_full_name;
  ...
  private:
      ...
      const std::string& method_name)
    {
      ...
      {
        Stream::Error stream;
        stream << FNS << ": google::protobuf::DescriptorPool::generated_pool is null";
        throw Exception(stream);
      }
      ...
      {
        Stream::Error stream;
        stream << FNS << ": Unknow servic = " << service_full_name;
        throw Exception(stream);
      }
      ...
      {
        Stream::Error stream;
        stream << FNS << ": Unknow method = " << method_name << " in service" <<
          service_full_name;
        throw Exception(stream);
      }
      ...
      {
        Stream::Error stream;
        stream << FNS << ": not correct request type for service=" <<
          service_full_name << " whith method=" << method_name;
        throw Exception(stream);
      }
      ...
      {
        Stream::Error stream;
        stream << FNS << ": not correct response type for service=" <<
          service_full_name << " with method=" << method_name;
        throw Exception(stream);
      }
      ...
      case grpc::internal::RpcMethod::NORMAL_RPC:
      {
        ...
        {
          Stream::Error stream;
          stream << FNS << ": incoming type in proto is streaming in NORMAL_RPC mode" <<
            " for service=" << service_full_name << " with method=" << method_name;
          throw Exception(stream);
        }
        ...
        {
          Stream::Error stream;
          stream << FNS << ": outgoing type in proto is streaming in NORMAL_RPC mode" <<
            " for service=" << service_full_name << " with method=" << method_name;
          throw Exception(stream);
        }
      ...
      case grpc::internal::RpcMethod::CLIENT_STREAMING:
      {
        ...
        {
          Stream::Error stream;
          stream << FNS << ": incoming type in proto is not streaming in "
            "CLIENT_STREAMING mode for service=" << service_full_name <<
        ...
        {
          Stream::Error stream;
          stream << FNS << ": outgoing type in proto is streaming in "
            "CLIENT_STREAMING mode for service=" << service_full_name <<
            " with method=" << method_name;
          throw Exception(stream);
        }
      ...
      case grpc::internal::RpcMethod::SERVER_STREAMING:
      {
        ...
        {
          Stream::Error stream;
          stream << FNS << ": incoming type in proto is streaming in "
            "SERVER_STREAMING mode for service=" << service_full_name <<
            " with method=" << method_name;
          throw Exception(stream);
        }
        ...
        {
          Stream::Error stream;
          stream << FNS << ": outgoing type in proto is not streaming in "
            "SERVER_STREAMING mode for service=" << service_full_name <<
            " with method=" << method_name;
          throw Exception(stream);
        }
      ...
      case grpc::internal::RpcMethod::BIDI_STREAMING:
      {
        if (!method_descriptor->client_streaming())
        {
          Stream::Error stream;
          stream << FNS << ": incoming type in proto is not streaming in "
            "BIDI_STREAMING mode for service=" << service_full_name <<
            " with method=" << method_name;
          throw Exception(stream);
        }
  ...
  private:
    ...
    const RpcPoolImpl_var rpc_pool_;

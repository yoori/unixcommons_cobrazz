...
public:
  ...
  using Factories = std::vector<GrpcClientFactory_var>;
...
public:
  Benchmark(
    ...
    const std::string& message,
    const std::size_t number_initial_message,
    const std::vector<GrpcClientFactory_var>& factories,
...
public:
  ...
  int run()
  {
    ...
    auto inititialize_func1 =
      [this, logger] (TaskProcessorContainer& task_processor_container) {
    ...
    auto inititialize_func2 = [
      ...
      &statistics] (
        ...
        std::vector<GrpcClientFactory_var> client_factories;

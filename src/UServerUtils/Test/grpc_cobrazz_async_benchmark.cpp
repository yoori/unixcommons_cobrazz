...
{
private:
  using WriterStatus = UServerUtils::Grpc::Client::WriterStatus;
  using ShutdownManagerPtr = UServerUtils::Grpc::Common::ShutdownManagerPtr;
...
private:
  ...
  using ShutdownManager =
    UServerUtils::Grpc::Common::ShutdownManager;
  using ShutdownManagerPtr =
    UServerUtils::Grpc::Common::ShutdownManagerPtr;
  using ShutdownManagers = std::list<ShutdownManagerPtr>;
  using Impl = StreamStreamClientImpl;
  using Config = UServerUtils::Grpc::Client::Config;
  using Logger = Logging::Logger;
  using Logger_var = Logging::Logger_var;
...
{
private:
  using Server = UServerUtils::Grpc::Server::Server;
  using Server_var = UServerUtils::Grpc::Server::Server_var;
  using Logger_var = Logging::Logger_var;
...
public:
  ...
  void run()
  {
    ...
    UServerUtils::Grpc::Server::Config server_config;
    ...
    UServerUtils::Grpc::Client::Config client_config;

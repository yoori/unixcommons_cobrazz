#ifndef USERVER_TASKPROCESSORCONTAINERBUILDER_HPP
#define USERVER_TASKPROCESSORCONTAINERBUILDER_HPP
...
class TaskProcessorContainerBuilder final : private Generics::Uncopyable
{
public:
...
using TaskProcessorContainerBuilderPtr = std::unique_ptr<TaskProcessorContainerBuilder>;

} // namespace UServerUtils

#endif //USERVER_TASKPROCESSORCONTAINERBUILDER_HPP

...
namespace Sync
{
  ...
  void Conditional::wait(pthread_mutex_t& mutex)
    /*throw (Exception, eh::Exception)*/
  {
    ...
    if (RES)
    {
      eh::throw_errno_exception<Exception>(RES, FNE, "Failed to wait on condition");
    }
  }

  bool
  Conditional::timed_wait(pthread_mutex_t& mutex, const Generics::Time* time, bool time_is_relative)
    /*throw (Exception, eh::Exception)*/
  {
    if (!time)
    {
  ...
  void Conditional::signal() /*throw (Exception, eh::Exception)*/
  {
    ...
    if (RES)
    {
      eh::throw_errno_exception<Exception>(RES, FNE, "Failed to signal condition");
    }
  }

  void Conditional::broadcast() /*throw (Exception, eh::Exception)*/
  {
    ...
    if (RES)
    {
      eh::throw_errno_exception<Exception>(RES, FNE, "Failed to broadcast condition");
    }
  }
  ...
  void Condition::wait() /*throw (Exception, eh::Exception)*/
  {
    Conditional::wait(*this);
  }

  bool Condition::timed_wait(const Generics::Time* time, bool time_is_relative)
    /*throw (Exception, eh::Exception)*/
  {
  ...
  ConditionalGuard::ConditionalGuard(Condition& condition) noexcept
    : PosixGuard(condition), conditional_(condition), mutex_(condition)
  {
  }

  ConditionalGuard::ConditionalGuard(Conditional& conditional, pthread_mutex_t& mutex) noexcept
    : PosixGuard(mutex), conditional_(conditional), mutex_(mutex)
  {
  }

  void ConditionalGuard::wait()
    /*throw (Conditional::Exception, eh::Exception)*/
  {
    conditional_.wait(mutex_);
  }

  bool ConditionalGuard::timed_wait(const Generics::Time* time, bool time_is_relative)
    /*throw (Conditional::Exception, eh::Exception)*/
  {

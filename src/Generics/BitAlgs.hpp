...
namespace Generics::BitAlgs
{
   ...
   */
  inline unsigned lowest_bit_64(uint64_t n) noexcept
  {
    uint64_t r, t;
    __asm__( "movq $64, %1\n" "bsfq %2, %0\n" "cmoveq %1, %0\n" : "=&r" (r), "=&r" (t) : "rm" (n));
    return r;
   ...
   */
  inline unsigned lowest_bit_32(uint32_t n) noexcept
  {
    uint64_t r, t;
    __asm__(
      "movl $32, %%edx\n"
   ...
   */
  inline unsigned highest_bit_64(uint64_t n) noexcept
  {
    uint64_t r, t;
    __asm__( "movq $64, %1\n" "bsrq %2, %0\n" "cmoveq %1, %0\n" : "=&r" (r), "=&r" (t) : "rm" (n));
    return r;
   ...
   */
  inline unsigned highest_bit_32(uint32_t n) noexcept
  {
    uint64_t r, t;
    __asm__(
      "movl $32, %%edx\n"
   ...
   */
  inline uint64_t leave_highest_64(uint64_t n) noexcept
  {
    uint64_t r, t;
    __asm__(
      "xorq %0, %0\n"

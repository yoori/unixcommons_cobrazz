...
namespace Generics::ValuesHelper
{
  ...
  Values::String
  Values::StoredValue::* const StoredMember<Values::String>::MEMBER = &Values::StoredValue::string;

  const Values::StoredType StoredMember<char*>::TYPE;
  Values::String
  Values::StoredValue::* const StoredMember<char*>::MEMBER = &Values::StoredValue::string;

  const Values::StoredType StoredMember<const char*>::TYPE;
  Values::String
  Values::StoredValue::* const StoredMember<const char*>::MEMBER = &Values::StoredValue::string;
}
...
namespace Generics
{
  ...
  void Values::swap(Values& values) /*throw (eh::Exception)*/
  {
    Sync::PosixGuard guard(mutex_);
    data_.swap(values.data_);
  }

  void Values::swap_(Values& values) /*throw (eh::Exception)*/
  {
    data_.swap(values.data_);
  }
}

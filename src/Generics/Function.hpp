...
namespace Generics::FunctionHelper
{
  inline String::SubString get_function_name(const char* function) noexcept
  {
  ...
  inline String::SubString get_template_info(const char* function) noexcept
  {
    ...
    return String::SubString(function, String::CharTraits<char>::length(function) - 1);
  }
}

 ...
 */
namespace Generics::BoolFunctorsHelper
{
  /**
  ...
  protected:
     ...
     */
    PredicatesHolder2(const Predicate1& predicate1, const Predicate2& predicate2) noexcept;
...
namespace Generics
{
  ...
  public:
     ...
     * @return true
     */
    bool operator ()(typename Predicate1::argument_type arg) const
      /*throw (eh::Exception)*/;
  };
  ...
  public:
     ...
     * @return true
     */
    bool operator ()(typename Predicate1::first_argument_type arg1,
...
namespace Generics::BoolFunctorsHelper
{
   ...
   */
  template <typename Predicate1>
  inline PredicatesHolder1<Predicate1>::PredicatesHolder1( const Predicate1& predicate1) noexcept
...
namespace Generics
{
   ...
   */
  template <typename Predicate1>
  inline True1<Predicate1>::True1(const Predicate1& predicate1) noexcept
    : BoolFunctorsHelper::PredicatesHolder1<Predicate1>(predicate1)
  {
  }

  template <typename Predicate1>
  inline bool True1<Predicate1>::operator ()( typename Predicate1::argument_type arg) const
    /*throw (eh::Exception)*/
  {
   ...
   */
  template <typename Predicate1>
  inline True2<Predicate1>::True2(const Predicate1& predicate1) noexcept
    : BoolFunctorsHelper::PredicatesHolder1<Predicate1>(predicate1)
  {
  }

  template <typename Predicate1>
  inline bool True2<Predicate1>::operator ()(
   ...
   */
  template <typename Predicate1>
  inline False1<Predicate1>::False1(const Predicate1& predicate1) noexcept
    : BoolFunctorsHelper::PredicatesHolder1<Predicate1>(predicate1)
  {
  }

  template <typename Predicate1>
  inline bool False1<Predicate1>::operator ()( typename Predicate1::argument_type arg) const
    /*throw (eh::Exception)*/
  {
   ...
   */
  template <typename Predicate1>
  inline False2<Predicate1>::False2(const Predicate1& predicate1) noexcept
    : BoolFunctorsHelper::PredicatesHolder1<Predicate1>(predicate1)
  {
  }

  template <typename Predicate1>
  inline bool False2<Predicate1>::operator ()(
    typename Predicate1::first_argument_type arg1,
    typename Predicate1::second_argument_type arg2) const
    /*throw (eh::Exception)*/
  {
   ...
   */
  template <typename Predicate1>
  inline Not1<Predicate1>::Not1(const Predicate1& predicate1) noexcept
    : BoolFunctorsHelper::PredicatesHolder1<Predicate1>(predicate1)
  {
  }
   ...
   */
  template <typename Predicate1>
  inline bool Not1<Predicate1>::operator ()( typename Predicate1::argument_type arg) const
    /*throw (eh::Exception)*/
  {
   ...
   */
  template <typename Predicate1>
  inline Not2<Predicate1>::Not2(const Predicate1& predicate1) noexcept
    : BoolFunctorsHelper::PredicatesHolder1<Predicate1>(predicate1)
  {
  }

  template <typename Predicate1>
  inline bool Not2<Predicate1>::operator ()(
    typename Predicate1::first_argument_type arg1,
    typename Predicate1::second_argument_type arg2) const
    /*throw (eh::Exception)*/
  {
  ...
  And1<Predicate1, Predicate2>::And1(const Predicate1& predicate1,
    ...
    : BoolFunctorsHelper::PredicatesHolder2<Predicate1, Predicate2>( predicate1, predicate2)
  {
  }

  template <typename Predicate1, typename Predicate2>
  inline
  bool And1<Predicate1, Predicate2>::operator ()( typename Predicate1::argument_type arg) const
    /*throw (eh::Exception)*/
  {
  ...
  template <typename Predicate1, typename Predicate2>
  inline bool And2<Predicate1, Predicate2>::operator ()(
    typename Predicate1::first_argument_type arg1,
    typename Predicate1::second_argument_type arg2) const
    /*throw (eh::Exception)*/
  {
  ...
  template <typename Predicate1, typename Predicate2>
  inline
  bool Or1<Predicate1, Predicate2>::operator ()( typename Predicate1::argument_type arg) const
    /*throw (eh::Exception)*/
  {
    return this->predicate1_(arg) || this->predicate2_(arg);
  }
  ...
  template <typename Predicate1, typename Predicate2>
  inline bool Or2<Predicate1, Predicate2>::operator ()(
    typename Predicate1::first_argument_type arg1,
    typename Predicate1::second_argument_type arg2) const
    /*throw (eh::Exception)*/
  {
  ...
  Conditional1<Predicate1, Predicate2, Predicate3>::Conditional1(
    ...
    : BoolFunctorsHelper::PredicatesHolder3
        <Predicate1, Predicate2, Predicate3>( predicate1, predicate2, predicate3)
  {
  }

  template <typename Predicate1, typename Predicate2, typename Predicate3>
  inline bool Conditional1<Predicate1, Predicate2, Predicate3>::operator ()(
  ...
  template <typename Predicate1, typename Predicate2, typename Predicate3>
  inline bool Conditional2<Predicate1, Predicate2, Predicate3>::operator ()(
    typename Predicate1::first_argument_type arg1,
    typename Predicate1::second_argument_type arg2) const
    /*throw (eh::Exception)*/
  {
  ...
  conditional1(const Predicate1& predicate1, const Predicate2& predicate2,
    const Predicate3& predicate3) noexcept
  {
    return Conditional1<Predicate1, Predicate2, Predicate3>( predicate1, predicate2, predicate3);
  }
  ...
  conditional2(const Predicate1& predicate1, const Predicate2& predicate2,
    const Predicate3& predicate3) noexcept
  {
    return Conditional2<Predicate1, Predicate2, Predicate3>( predicate1, predicate2, predicate3);
  }
}

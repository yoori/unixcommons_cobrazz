...
namespace Generics::AppUtils
{
  ...
  public:
    ...
    bool require_value() const noexcept;
    bool enabled() const noexcept;

    void set(const char* opt_name, const char* val) noexcept;
  ...
  public:
    ...
    void set(const char* opt_name, const char* val) /*throw (InvalidParam)*/;
    void set_value(const Object& val) noexcept;
  ...
  {
  public:
    using ValueType = typename Object::value_type;
    /**
  ...
  {
  public:
    using CommandList = std::list<std::string>;

    explicit Args(long command_count = 0) /*throw (eh::Exception)*/;
    ...
    void usage(std::ostream& ostr) const /*throw (eh::Exception)*/;
  ...
  protected:
    ...
    public:
      ...
      bool next_word() noexcept;
      bool end() noexcept;

      const char* current_pos() noexcept;
      void current_pos(const char* pos) noexcept;
    ...
    public:
      virtual void set(const char* opt_name, const char* val) /*throw (InvalidParam)*/ = 0;

      virtual bool require_value() const noexcept = 0;
    };
    using OptionSetter_var = ReferenceCounting::QualPtr<OptionSetter>;

    using OptionSetterMap = ReferenceCounting::Map<std::string, OptionSetter_var>;

    bool parse_eq_op_(ParseState& parse_state)
      /*throw (eh::Exception, Exception, InvalidParam)*/;

    bool parse_short_opt_seq_(ParseState& parse_state)
      /*throw (Exception, InvalidParam)*/;
    bool parse_short_opt_(ParseState& parse_state)
      /*throw (Exception, InvalidParam)*/;
    void
  ...
  private:
    ...
    public:
      ...
      virtual void set(const char* opt_name, const char* val) /*throw (InvalidParam)*/;

      virtual bool require_value() const noexcept;
    ...
    using Usage = std::map<std::string, std::string>;
  ...
  inline OptionCont equal_name(const char* name)
  {
    OptionCont ret;
  ...
  inline OptionCont short_name(const char* name)
  {
    OptionCont ret;
...
namespace Generics::AppUtils
{
  ...
  inline bool CheckOption::require_value() const noexcept
  {
    return false;
  }
  ...
  inline void CheckOption::set(const char* /*opt_name*/, const char* /*val*/) noexcept
  {
    enabled_ = true;
  }
  ...
  template <typename Object>
  bool Option<Object>::require_value() const noexcept
  {
    return true;
  }
  ...
  template <typename Object>
  void Option<Object>::set(const char* /*opt_name*/, const char* val)
    /*throw (InvalidParam)*/
  {
    if (installed())
    {
  ...
  template <typename Object>
  void Option<Object>::set_value(const Object& val) noexcept
  {
    val_ = val;
    installed_ = true;
  }
  ...
  template <typename Object>
  void OptionsSet<Object>::set(const char* /*opt_name*/, const char* val)
    /*throw (InvalidParam)*/
  {
    Stream::Parser istr{String::SubString(val)};
    ValueType value;
  ...
  inline void StringOption::set(const char* /*opt_name*/, const char* val)
    /*throw (InvalidParam)*/
  {
    if (installed())
    {
  ...
  template <typename Option>
  bool Args::OptionSetterImpl<Option>::require_value() const noexcept
  {
  ...
  inline Args::Args(long command_count) /*throw (eh::Exception)*/

...
namespace String::SequenceAnalyzer
{
  ...
  void interprete_base_seq(std::istream& istr, ResultType& result_arg)
    /*throw (BasicAnalyzerException, eh::Exception)*/
  {
    ...
    {
      Stream::Error ostr;
      ostr << FNS << "Got Generics::SequenceAnalyzer::Analyzer::Exception: " << e.what();
  ...
  void interprete_base_sequence(std::istream& istr, std::ostream& ostr)
    /*throw (BasicAnalyzerException, eh::Exception)*/
  {
    interprete_base_seq<std::ostream>(istr, ostr);
  }

  void interprete_base_sequence(std::istream& istr, std::list<std::string>& ret_list)
    /*throw (BasicAnalyzerException, eh::Exception)*/
  {

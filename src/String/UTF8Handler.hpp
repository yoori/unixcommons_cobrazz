...
namespace String::UTF8Handler
{
   ...
   */
  bool is_correct_utf8_sequence(const char* src, unsigned long& octets_count) noexcept;
  ...
  bool utf8_char_to_wchar(const char* src, unsigned long octets_count, wchar_t& dest) noexcept;

  bool
  wchar_to_utf8(const wchar_t* src, char* dest_buff, unsigned long& dest_octets_count) noexcept;

  bool wchar_to_utf8_char(wchar_t src, char* dest_buff, unsigned long& dest_octets_count) noexcept;
...
namespace String::UTF8Handler
{
  inline bool is_correct_utf8_sequence(const char* src, unsigned long& octets_count) noexcept
  {
  ...
  inline unsigned long get_octet_count(char ch) noexcept
  {
    return TRAILING_BYTES_FOR_UTF8[static_cast<uint8_t>(ch)];
  }

  static const unsigned char FIRST_BYTE_MASKS[7] = { 0, 0x7F, 0x1F, 0x0F, 0x07, 0x03, 0x01 };

...
namespace String
{
  ...
  public:
     ...
     */
    Fmt(const char* fmt, ...) noexcept __attribute__((format(printf, 2, 3)));
    /**
...
namespace String::StringManip
{
  ...
  void
  base64mod_decode(std::string& dst, std::string_view src, bool padding = true, uint8_t* fill = 0)
    /*throw (InvalidFormatException, eh::Exception)*/;

  void
  base64mod_decode(std::string& dst, const std::string& src, bool padding = true, uint8_t* fill = 0)
    /*throw (InvalidFormatException, eh::Exception)*/;
   ...
   */
  constexpr size_t base64mod_encoded_size(size_t original_size, bool padding = true) noexcept;
   ...
   */
  constexpr size_t base64mod_max_decoded_size(size_t original_size) noexcept;
   ...
   */
  constexpr size_t base64mod_fill_size(size_t original_size) noexcept;
   ...
   */
  void mime_url_encode(const String::SubString& src, std::string& dst)
    /*throw (eh::Exception)*/;

  void mime_url_encode(std::string_view src, std::string& dst)
    /*throw (eh::Exception)*/;

  inline void mime_url_encode(const std::string& src, std::string& dst)
    /*throw (eh::Exception)*/
  {
   ...
   */
  void mime_url_decode(const String::SubString& src, std::string& dst, bool strict = true)
   ...
   */
  void
  xml_encode(const wchar_t* src, std::string& dst, unsigned long units = XU_TEXT | XU_ATTRIBUTE)
    /*throw (eh::Exception)*/;
   ...
   * otherwise as &x#XXXX
   */
  void xml_encode(const char* src, std::string& dst, unsigned long units = XU_TEXT | XU_ATTRIBUTE)
    /*throw (InvalidFormatException, eh::Exception)*/;
   ...
   */
  void xml_decode(const String::SubString& src, std::string& dst)
    /*throw (InvalidFormatException, eh::Exception)*/;
   ...
   * @param dst encoded string
   */
  void js_unicode_encode(const char* src, std::string& dst)
    /*throw (InvalidFormatException, eh::Exception)*/;
   ...
   * @param dst encoded string
   */
  void js_encode(const char* src, std::string& dst)
    /*throw (eh::Exception)*/;
  ...
  void json_escape_append( std::string& dest, const std::basic_string<char, Traits, Allocator>& src)
    /*throw (eh::Exception)*/
  {
   ...
   */
  Generics::ArrayWChar utf8_to_wchar(const String::SubString& src)
    /*throw (eh::Exception, InvalidFormatException)*/;
   ...
   */
  void wchar_to_utf8(const wchar_t* src, std::string& str)
    /*throw (eh::Exception)*/;
   ...
   * @param str resulted UTF-8 string
   */
  void wchar_to_utf8(const String::WSubString& src, std::string& str)
    /*throw (eh::Exception)*/;
   ...
   */
  void wchar_to_utf8(wchar_t src, std::string& str)
    /*throw (eh::Exception)*/;
   ...
   */
  bool
  utf8_substr(const String::SubString& src, size_t max_octets, String::SubString& dst) noexcept;
   ...
   */
  void
  trim(SubString& str, const AsciiStringManip::CharCategory& trim_set = AsciiStringManip::SPACE)
    noexcept;
   ...
   */
  String::SubString
  trim_ret(SubString str, const AsciiStringManip::CharCategory& trim_set = AsciiStringManip::SPACE)
    noexcept;
  ...
  public:
     ...
     */
    Translit(const char* invalid, const char* valid) noexcept;
     ...
     */
    void translit(const char* src, std::string& dest) const
      /*throw (eh::Exception)*/;
     ...
     * @param dest string with replaced symbols
     */
    void translit(const String::SubString& src, std::string& dest) const
      /*throw (eh::Exception)*/;
     ...
     */
    void translit(char* str) const noexcept;
     ...
     * @param size its size
     */
    void translit(char* str, size_t size) const noexcept;
  ...
  public:
     ...
     */
    template <typename Integer>
    explicit IntToStr(Integer value) noexcept;
  ...
  public:
     ...
     */
    template <typename... T>
    explicit InverseCategory(T... args) /*throw (eh::Exception)*/;
    ...
    bool is_owned(Character ch) const noexcept;
     ...
     */
    template <typename Character>
    bool operator ()(Character ch) const noexcept;
     ...
     */
    const char*
    find_owned(const char* begin, const char* end, unsigned long* octets = 0) const noexcept;
     ...
     */
    const char*
    find_nonowned(const char* begin, const char* end, unsigned long* octets = 0) const noexcept;
     ...
     */
    const char*
    rfind_owned(const char* pos, const char* start, unsigned long* octets = 0) const noexcept;
     ...
     */
    const char*
    rfind_nonowned(const char* pos, const char* start, unsigned long* octets = 0) const noexcept;
  };

  void concat(char* buffer, size_t size) noexcept;
  ...
  void concat(char* buffer, size_t size, First f, Args... args) noexcept;
   ...
   */
  size_t hex_decode(SubString src, Generics::ArrayByte& dst, bool allow_odd_string = false)
    /*throw (eh::Exception, InvalidFormatException)*/;
}

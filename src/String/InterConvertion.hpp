...
namespace String::International
{
  ...
  public:
     ...
     * @param from_code Character encoding conversion from
     */
    void set_encodings(const char* to_code, const char* from_code)
      /*throw (NotSupported)*/;
     ...
     */
    void encode(const char* input_chars, size_t count, std::string& out)
...
namespace String::International
{
  inline Convertion::Convertion() noexcept
    : fd_(INVALID_), mult_(1)
  {
  }

  inline Convertion::Convertion(const char* to_code, const char* from_code)
    /*throw(NotSupported)*/
    : fd_(INVALID_), mult_(1)
  {

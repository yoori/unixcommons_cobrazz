...
{
public:
  using SlowdownFilterModule_var = ReferenceCounting::QualPtr<SlowdownFilterModule>;
  ...
  public:
    ...
    virtual apr_status_t filter(ap_filter_t* f, apr_bucket_brigade* bb) noexcept;
...
public:
  ...
  virtual void insert_filter(request_rec* r) noexcept;

protected:
  virtual ~SlowdownFilterModule() noexcept;

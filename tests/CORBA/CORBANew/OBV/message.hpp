...
char* MessageHolder_i::get_message()
{
  return CORBA::string_dup(message());
}

#ifdef TESTING_CUSTOM
void MessageHolder_i::message (char *val)
{
  ::CORBA::String_var tmp(val);
  message_ = val;
}
void MessageHolder_i::message (const char *val)
{
  message_ = val;
}
void MessageHolder_i::message (const ::CORBA::String_var &val)
{
  message_ = val;
}
const char * MessageHolder_i::message (void) const
{

...
main()
{
  /*
  {
    Decimal<uint64_t, 18, 9> dec1(false, 1, 0);
    Decimal<uint64_t, 18, 9> coef = SimpleDecimal<uint64_t, 18, 9>::div(
      SimpleDecimal<uint64_t, 18, 9>(false, 1, 0),
      SimpleDecimal<uint64_t, 18, 9>(false, 5, 0)); // 0.2
    uint64_t r = Decimal<uint64_t, 36, 16>::mul(
      Decimal<uint64_t, 36, 16>(false, 100, 0),
      Decimal<uint64_t, 36, 16>(coef),
      Generics::DMR_FLOOR).integer<uint64_t>();
